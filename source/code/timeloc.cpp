...
wxString getTimeStr(int value, ETimeUnit unit, wxString const &lang) {
    ...
    if (lang == L"en") {
        ...
        if (hours >= 2) {
            ...
            if (minutes_mod_10 >= 2 && minutes_mod_10 <= 4 && minutes / 10 != 1) {
                return wxString::Format(L"1 %s %d %s", langPack->Get("hour"), minutes, langPack->Get("minutes_"));
            } else if (minutes_mod_10 == 1 && minutes != 11) {
                return wxString::Format(L"1 %s %d %s", langPack->Get("hour"), minutes, langPack->Get("minute"));
            } else if (minutes_mod_10 == 0 || (minutes >= 5 && minutes <= 19) || (minutes_mod_10 >= 5 && minutes_mod_10 <= 9)) {
                if (minutes != 0)
        ...
        } else if ((minutes_mod_10 == 0 && minutes != 0) || (minutes >= 5 && minutes <= 19) ||
                   (minutes_mod_10 >= 5 && minutes_mod_10 <= 9)) // 5-19, 20, 25-29, 30, 35-39 �����
        {
