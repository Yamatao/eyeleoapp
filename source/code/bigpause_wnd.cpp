...
void BigPauseWindow::Init() {
    ...
    // logging::msg(wxString::Format("BigPauseWindow init displayInd=%d, x=%d, y=%d, w=%d, h=%d", _displayInd, displayRect.GetPosition().x,
    // displayRect.GetPosition().y, displayRect.GetSize().GetWidth(), displayRect.GetSize().GetHeight()));
